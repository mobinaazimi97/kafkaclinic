...
import com.mftplus.patient.service.CustomUserDetailsService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/login", "/css/**", "*/**", "/h2-console/**", "/public/**", "/api/test/public/**").permitAll() // Allow public access to certain paths
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("https://localhost:9443")); // Allow specific origin
